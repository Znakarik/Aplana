...
public class OurFileReader {
    ...
    private static File file = new File("./hw2/src/main/resources/file");
    private static File file1 = new File("./hw2/src/main/resources/file2");
    private static File file2 = new File("./hw2/src/main/resources/text");
